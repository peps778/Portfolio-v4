  ...
  return (
    ...
    <div className="max-w-6xl flex flex-wrap items-center justify-between mx-auto p-8">
      <a href="https://magbanua-pauljhon.website" className="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span className="self-center max-sm:text-3xl sm:text-2xl md:text-3xl xl:text-3xl font-semibold whitespace-nowrap dark:text-[#f5f5f5] text-white">Paul Jhon Magbanua</span>
      </a>
      ...
      <div className="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul className="font-medium text-2xl flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[#020618] md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-[#020618] text-[#f5f5f5]">
          <li>
